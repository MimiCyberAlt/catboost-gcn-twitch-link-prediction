...
| **CatBoost** | **0.9004** | 486.50 сек | ~500 деревьев |

> 🏆 **GCN** показал лучшее качество и скорость
...
| **Скорость** | 486.50 сек | **116.71 сек**🏆 |
| **Интерпретируемость** | ✅ Высокая | ❌ Сложная |

**Рекомендация:**
- Для нахождения конкретных признаков → **CatBoost** (понятные признаки)
